                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Created</th>
                                            <th class="md:px-4 py-3 title-font tracking-wider font-medium text-black bg-gray-100"></th>
                                            <th class="md:px-4 py-3 title-font tracking-wider font-medium text-black bg-gray-100"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
