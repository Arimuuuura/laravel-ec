...
{{--                            <x-thumbnail filename="{{$product->imageFirst->filename ?? ''}}" type="products" />--}}
                    ...
                    <div class="mb-4 text-center">
                        <button data-micromodal-trigger="modal-1" href="javascript:;" type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細</button>
                    </div>
                </div>
            </div>
        </div>
